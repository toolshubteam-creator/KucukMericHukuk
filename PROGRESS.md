...
| 5.6 | Cloudflare Turnstile (Contact form bot koruması): TurnstileOptions (Core/Common) + ITurnstileVerifier (Infrastructure/Security) + IHttpClientFactory typed client + ContactForm widget (managed mode, demo key default) + controller verify + 5 birim test | _pending_ |
