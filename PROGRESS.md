...
| 5.4 | Breadcrumb component + BreadcrumbList JSON-LD: BreadcrumbItem POCO + _Breadcrumb partial + IJsonLdService.BuildBreadcrumbList + 9 view ViewData set + site.css breadcrumb block + 3 birim test | _pending_ |
