...
| ✅ 7.2a | Abone altyapısı (Subscriber entity + public footer formu + token iptal + admin liste; bülten gönderimi 7.2b'de) — UX fix uygulandı (AJAX content negotiation + subscribe bant + sade footer) | — | — | ~1 alt-adım |
