...
// NOT: Kurallar Business/Validators/ServiceInputValidator.cs'ten ayna kopya.
public class ServiceFormViewModelValidator : AbstractValidator<ServiceFormViewModel>
{
    public ServiceFormViewModelValidator()
    {
        ...
        RuleForEach(x => x.Translations).SetValidator(new ServiceTranslationFormViewModelValidator());
...
public class ServiceTranslationFormViewModelValidator : AbstractValidator<ServiceTranslationFormViewModel>
{
    private static readonly Regex SlugRegex = new(
        "^[a-z0-9]+(-[a-z0-9]+)*$",
        RegexOptions.Compiled);

    public ServiceTranslationFormViewModelValidator()
    {
