...
public interface IMediaService
{
    ...
    /// <summary>Public /Galeri sayfası için IsPublic=true + image content-type, sayfalı.</summary>
    Task<PagedResult<MediaFilePublicDto>> GetPublicGalleryAsync(int page, int pageSize, CancellationToken ct = default);
